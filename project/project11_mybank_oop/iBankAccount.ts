...
export class Customer {
    ...
    {
        return `Name: ${this.FirstName} ${this.LastName} Age: ${this.Age} Gender: ${this.Gender} Mobile Number: ${this.MobileNumber} `;
    }
    public CustomerBalance () : string 
    {
        return ` Account Balance : ${this.bankAccount.AccountBalance }`;
    }
    }
